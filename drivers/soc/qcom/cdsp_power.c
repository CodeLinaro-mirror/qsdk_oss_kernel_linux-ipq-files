...
struct cdsp_smem_channel_hdr {
	u32 magic;
	u32 version;
	volatile u32 cdsp_state;
	volatile u32 apss_state;
	u32 request_offset;
	u32 request_size;
	u32 response_offset;
	u32 response_size;
	volatile u32 request_in_flight;
...
static int cdsp_power_remove(struct platform_device *pdev)
{
