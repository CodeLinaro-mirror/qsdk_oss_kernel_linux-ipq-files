...
static const struct pinctrl_pin_desc ipq5610_pins[] = {
...
static const char *const bist_complete_groups[] = {
	"gpio36",
};

static const char *const bist_fail_groups[] = {
	"gpio37",
};

static const char *const bist_start_groups[] = {
	"gpio34",
};

static const char *const bist_stop_groups[] = {
	"gpio35",
};
...
static const char *const core_voltage_5_groups[] = {
	"gpio61",
};
...
static const char *const ddr_pxi00_groups[] = {
	"gpio34",
	"gpio36",
};

static const char *const ddr_pxi01_groups[] = {
	"gpio35",
	"gpio37",
};
...
static const char *const pcie4_phy0_groups[] = {
	"gpio26",
};

static const char *const pcie4_phy1_groups[] = {
	"gpio27",
};
...
static const char *const pwm_out13_groups[] = {
	"gpio57",
};
...
static const char *const pwm_out23_groups[] = {
	"gpio58",
};
...
static const char *const pwm_out33_groups[] = {
	"gpio59",
};
...
static const char *const pwm_out43_groups[] = {
	"gpio60",
};
...
static const char *const pwm_out52_groups[] = {
	"gpio0",
};

static const char *const pwm_out53_groups[] = {
	"gpio61",
};
...
static const char *const qdss_tracedata_a_groups[] = {
	...
	"gpio12", "gpio14", "gpio15", "gpio16", "gpio20", "gpio21",
...
static const char *const qup_se3_l00_groups[] = {
	"gpio57",
};

static const char *const qup_se3_l01_groups[] = {
	"gpio60",
};

static const char *const qup_se3_l10_groups[] = {
	"gpio22",
};

static const char *const qup_se3_l11_groups[] = {
	"gpio61",
};
...
static const char *const tgu_ch0_trigout0_groups[] = {
	"gpio48",
};

static const char *const tgu_ch0_trigout1_groups[] = {
	"gpio49",
};

static const char *const tgu_ch0_trigout2_groups[] = {
	"gpio50",
};

static const char *const tgu_ch0_trigout3_groups[] = {
	"gpio51",
};

static const char *const tgu_ch1_trigout0_groups[] = {
	"gpio16",
};

static const char *const tgu_ch1_trigout1_groups[] = {
	"gpio17",
};

static const char *const tgu_ch1_trigout2_groups[] = {
	"gpio18",
};

static const char *const tgu_ch1_trigout3_groups[] = {
	"gpio19",
};
...
static const struct pinfunction ipq5610_functions[] = {
 ...
 */
static const struct msm_pingroup ipq5610_groups[] = {
	[0] = PINGROUP(0, sdc_data3, qspi3, pwm_out52, _, _, _, _, _, _, _, _),
	[1] = PINGROUP(1, sdc_data2, qspi2, pwm_out42, _, _, _, _, _, _, _, _),
	[2] = PINGROUP(2, sdc_data1, qspi1, pwm_out32, _, _, _, _, _, _, _, _),
	[3] = PINGROUP(3, sdc_data0, qspi0, pwm_out22, _, _, _, _, _, _, _, _),
	[4] = PINGROUP(4, sdc_cmd, qspi_cs_n, pwm_out12, _, _, _, _, _, _, _, _),
	[5] = PINGROUP(5, sdc_clk, qspi_clk, pwm_out02, _, _, _, _, _, _, _, _),
	...
	[9] = PINGROUP(9, qup_se0_l1, led22, pwm_out01, _, qdss_tracedata_a, _, _, _, _, _, _),
	...
	[12] = PINGROUP(12, pon_tx_dis, qup_se2_l3, pwm_out10, audio_pri0, audio_pri0, _, qdss_tracedata_a, _, _, _, _),
	[13] = PINGROUP(13, _, qup_se2_l2, pwm_out00, _, _, _, _, _, _, _, _),
	[14] = PINGROUP(14, pon_tx_burst, qup_se0_l4, pwm_out40, _, qdss_tracedata_a, _, _, _, _, _, _),
	[15] = PINGROUP(15, pon_tx, qup_se0_l5, pwm_out50, _, qdss_tracedata_a, _, _, _, _, _, _),
	[16] = PINGROUP(16, pon_tx_sd, audio_sec1, audio_sec1, _, qdss_tracedata_a, tgu_ch1_trigout0, _, _, _, _, _),
	[17] = PINGROUP(17, pon_tx_fault, audio_sec0, audio_sec0, _, qdss_traceclk_a, tgu_ch1_trigout1, _, _, _, _, _),
	[18] = PINGROUP(18, pps, pll_test, qdss_tracectl_a, tgu_ch1_trigout2, _, _, _, _, _, _, _),
	[19] = PINGROUP(19, mux_tod_out, audio_pri1, audio_pri1, tgu_ch1_trigout3, _, _, _, _, _, _, _),
	[20] = PINGROUP(20, qup_se2_l1, mdc_slv1, tsens_max, qdss_tracedata_a, pwm_out41, _, _, _, _, _, _),
	[21] = PINGROUP(21, qup_se2_l0, mdio_slv1, qdss_tracedata_a, pwm_out51, _, _, _, _, _, _, _),
	[22] = PINGROUP(22, core_voltage_0, qup_se3_l10, pwm_out03, _, _, _, _, _, _, _, _),
	[23] = PINGROUP(23, Led00, dbg_out_clk, _, _, _, _, _, _, _, _, _),
	[24] = PINGROUP(24, _, _, _, _, _, _, _, _, _, _, _),
	[25] = PINGROUP(25, _, _, _, _, _, _, _, _, _, _, _),
	[26] = PINGROUP(26, mdc_mst, pcie4_phy0, _, _, _, _, _, _, _, _, _),
	[27] = PINGROUP(27, mdio_mst, pcie4_phy1, _, qdss_cti_trig_out_b0, _, _, _, _, _, _, _),
	...
	[31] = PINGROUP(31, pcie0_clk_req_n, mdc_slv0, qup_se6_l3, _, qdss_cti_trig_out_a1, _, _, _, _, _, _),
	[32] = PINGROUP(32, _, _, _, _, _, _, _, _, _, _, _),
	[33] = PINGROUP(33, pcie0_wake, mdio_slv0, qdss_cti_trig_in_a1, qup_se6_l2, _, _, _, _, _, _, _),
	[34] = PINGROUP(34, audio_pri_d0, atest_char_status0, qdss_cti_trig_in_b0, bist_start, ddr_pxi00, _, _, _, _, _, _),
	[35] = PINGROUP(35, audio_pri_d1, rx_los21, atest_char_status1, qdss_cti_trig_out_b1, bist_stop, ddr_pxi01, _, _, _, _, _),
	[36] = PINGROUP(36, audio_pri_fsync, rx_los11, atest_char_status2, bist_complete, ddr_pxi00, _, _, _, _, _, _),
	[37] = PINGROUP(37, audio_pri_pclk, rx_los01, atest_char_status3, bist_fail, ddr_pxi01, _, qdss_cti_trig_in_b1, _, _, _, _),
	[38] = PINGROUP(38, qup_se1_l3, led20, qdss_tracedata_a, _, _, _, _, _, _, _, _),
	[39] = PINGROUP(39, qup_se1_l2, led10, led01, gcc_tlmm, qdss_tracedata_a, _, _, _, _, _, _),
	[40] = PINGROUP(40, qup_se4_l2, rx_los20, audio_sec_fsync, qdss_tracedata_a, _, _, _, _, _, _, _),
	[41] = PINGROUP(41, qup_se4_l3, rx_los10, audio_sec_pclk, mdio_slv, qdss_tracedata_a, _, _, _, _, _, _),
	[42] = PINGROUP(42, qup_se4_l0, rx_los00, audio_sec_d1, mdio_slv, atest_tic_en, _, _, _, _, _, _),
	[43] = PINGROUP(43, qup_se4_l1, audio_sec_d0, _, _, _, _, _, _, _, _, _),
	[44] = PINGROUP(44, resout, _, _, _, _, _, _, _, _, _, _),
	[45] = PINGROUP(45, pon_mux_sel, ddr_pxi10, _, _, _, _, _, _, _, _, _),
	[46] = PINGROUP(46, dg_out, atest_char_start, ddr_pxi11, _, _, _, _, _, _, _, _),
	[47] = PINGROUP(47, _, mdc_slv2, qup_se5_l2, qup_se7_l3, audio_pri3, audio_pri3, _, _, _, _, _),
	[48] = PINGROUP(48, pon_rx, qup_se5_l3, qup_se7_l2, tgu_ch0_trigout0, _, _, _, _, _, _, _),
	[49] = PINGROUP(49, _, mdio_slv2, qup_se5_l00, audio_sec2, audio_sec2, tgu_ch0_trigout1, _, _, _, _, _),
	[50] = PINGROUP(50, _, qup_se5_l10, audio_sec3, audio_sec3, tgu_ch0_trigout2, _, _, _, _, _, _),
	[51] = PINGROUP(51, _, qup_se5_l4, tgu_ch0_trigout3, _, _, _, _, _, _, _, _),
	[52] = PINGROUP(52, qup_se7_l1, qup_se5_l5, qup_se4_l4, led21, _, _, _, _, _, _, _),
	[53] = PINGROUP(53, qup_se7_l0, qup_se4_l5, led11, _, _, _, _, _, _, _, _),
	[54] = PINGROUP(54, pcie2_clk_req_n, _, _, qup_se5_l01, gcc_plltest_bypassnl, ddr_pxi10, _, _, _, _, _),
	[55] = PINGROUP(55, _, _, _, _, _, _, _, _, _, _, _),
	[56] = PINGROUP(56, pcie2_wake, qup_se5_l11, gcc_plltest_resetn, ddr_pxi11, _, _, _, _, _, _, _),
	[57] = PINGROUP(57, core_voltage_1, qup_se3_l00, pwm_out13, _, _, _, _, _, _, _, _),
	[58] = PINGROUP(58, core_voltage_2, qup_se6_l0, pwm_out23, _, _, _, _, _, _, _, _),
	[59] = PINGROUP(59, core_voltage_3, qup_se6_l1, pwm_out33, _, _, _, _, _, _, _, _),
	[60] = PINGROUP(60, core_voltage_4, pwm_out43, _, _, qup_se3_l01, _, _, _, _, _, _),
	[61] = PINGROUP(61, core_voltage_5, pwm_out53, qup_se3_l11, _, _, _, _, _, _, _, _),
};

static const struct msm_pinctrl_soc_data ipq5610_tlmm = {
	.pins = ipq5610_pins,
	.npins = ARRAY_SIZE(ipq5610_pins),
	.functions = ipq5610_functions,
	.nfunctions = ARRAY_SIZE(ipq5610_functions),
	.groups = ipq5610_groups,
	.ngroups = ARRAY_SIZE(ipq5610_groups),
	.ngpios = 62,
	.egpio_func = 11,
};

static const struct of_device_id ipq5610_tlmm_of_match[] = {
	{ .compatible = "qcom,ipq5610-tlmm", .data = &ipq5610_tlmm },
	{},
};

static int ipq5610_tlmm_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &ipq5610_tlmm);
}

static struct platform_driver ipq5610_tlmm_driver = {
	.driver = {
		.name = "ipq5610-tlmm",
		.of_match_table = ipq5610_tlmm_of_match,
	},
	.probe = ipq5610_tlmm_probe,
	.remove_new = msm_pinctrl_remove,
};

static int __init ipq5610_tlmm_init(void)
{
	return platform_driver_register(&ipq5610_tlmm_driver);
}
arch_initcall(ipq5610_tlmm_init);

static void __exit ipq5610_tlmm_exit(void)
{
	platform_driver_unregister(&ipq5610_tlmm_driver);
}
module_exit(ipq5610_tlmm_exit);

MODULE_DESCRIPTION("QTI ipq5610 TLMM driver");
MODULE_LICENSE("GPL");
MODULE_DEVICE_TABLE(of, ipq5610_tlmm_of_match);
